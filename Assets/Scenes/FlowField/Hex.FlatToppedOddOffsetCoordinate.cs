namespace Assets.Sources.Scripts
{
    ...
    {
        private class FlatToppedOddOffsetCoordinate : CoordinateInterface
        {
            public Hex Hex { get; }
            public int X { get; }
            public int Y { get; }

            public FlatToppedOddOffsetCoordinate(Hex hex)
            {
                Hex = hex;
                X = hex.Q;
            ...
            //public static implicit operator Hex(FlatToppedOddOffsetCoordinate c)
            //{
